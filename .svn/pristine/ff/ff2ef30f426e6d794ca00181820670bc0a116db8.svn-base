                ...
                case SC_Exit:
                  {
                    ...
                    // currentThread->space->threadCounter--;
                    // while (currentThread->space->threadCounter > 0) {
                    //   DEBUG ('x', "Yield %d\n", currentThread->space->threadCounter);
                    //   currentThread->Yield();
                    // }
                    interrupt->Powerdown ();
                ...
                case SC_PutString:
                  {
                    ...
                    consoledriver->copyStringFromMachine(addr, buffer, MAX_STRING_SIZE);
                ...
                case SC_GetString:
                  {
                    ...
                    int n_string = n < MAX_STRING_SIZE ? n : MAX_STRING_SIZE;
                    consoledriver->GetString(buffer, n_string);
                    consoledriver->copyStringToMachine(buffer, addr, MAX_STRING_SIZE);
                    break;
                  }
                case SC_PutInt:
                  {
                ...
                case SC_GetInt:
                  {
                    ...
                    int n_buf;
                    int addr = machine->ReadRegister(4);
                    int r = consoledriver->GetInt(&n_buf);
                    consoledriver->copyIntToMachine(n_buf, addr);
